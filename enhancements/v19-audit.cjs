...
async function browserAudit(){
  ...
  try{
    ...
    await page.waitForFunction(()=>window.__PACEFOLD_V19__?.release==='20.0.1'&&window.__PACEFOLD_V20__?.release==='20.0.1'&&document.querySelectorAll('#workline .pf-ritual-slot[data-v19-ritual="true"]').length===6);
    ...
    assert(dashboard.release==='20.0.1',`V20 release marker is wrong: ${dashboard.release}`);
    ...
    await mobile.waitForFunction(()=>window.__PACEFOLD_V19__?.release==='20.0.1'&&window.__PACEFOLD_V20__?.release==='20.0.1');
    ...
    await wafer.waitForFunction(()=>window.__PACEFOLD_V19__?.release==='20.0.1'&&window.__PACEFOLD_V20__?.release==='20.0.1');
    ...
    await reduced.waitForFunction(()=>window.__PACEFOLD_V19__?.release==='20.0.1'&&window.__PACEFOLD_V20__?.release==='20.0.1');
