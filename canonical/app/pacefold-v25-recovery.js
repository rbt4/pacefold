...
const patchPrefs=patch=>window.__PACEFOLD_RHYTHM__?.patchPrefs?.(patch)||window.__PACEFOLD_CORE__?.updatePrefs?.(patch)||window.__PACEFOLD_RUNTIME_CORE__?.updatePrefs?.(patch)||fallbackPatch(patch);
