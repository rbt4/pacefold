...
source=source.replace("assert(/Open Pacefold/i.test(surface.enter),'Start surface lost the explicit Pacefold entrance')","assert(/Open clock/i.test(surface.enter),'Start surface lost the explicit Clock entrance')");
