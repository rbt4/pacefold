...
const APP_CSP="default-src 'none'; script-src 'self' https://www.youtube.com; style-src 'self'; font-src 'self'; img-src 'self' data: blob: https://i.ytimg.com https://geo.weather.gc.ca https://tilecache.rainviewer.com https://a.basemaps.cartocdn.com; media-src 'self' blob:; connect-src 'self' https://api.open-meteo.com https://air-quality-api.open-meteo.com https://geo.weather.gc.ca https://api.rainviewer.com https://login.microsoftonline.com https://graph.microsoft.com; frame-src https://login.microsoftonline.com https://www.youtube.com; worker-src 'self'; manifest-src 'self'; object-src 'none'; base-uri 'none'; form-action 'self' https://login.microsoftonline.com";
